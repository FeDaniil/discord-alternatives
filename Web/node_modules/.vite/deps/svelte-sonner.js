import "./chunk-ALDR4XGZ.js";
import "./chunk-WRTVL4GV.js";
import "./chunk-Z254SRBZ.js";
import {
  get as get2,
  writable
} from "./chunk-I3KPENQD.js";
import {
  add_locations,
  append_styles,
  bind_this,
...
function Toast($$anchor, $$props) {
  ...
  const isFront = mutable_state(void 0, true);
  const isVisible = mutable_state(void 0, true);
  const toastTitle = mutable_state(void 0, true);
  const toastDescription = mutable_state(void 0, true);
  const toastType = mutable_state(void 0, true);
  const toastClass = mutable_state(void 0, true);
  const toastDescriptionClass = mutable_state(void 0, true);
  const heightIndex = mutable_state(void 0, true);
  const coords = mutable_state(void 0, true);
  const toastsHeightBefore = mutable_state(void 0, true);
  const disabled = mutable_state(void 0, true);
  const isPromiseLoadingOrInfiniteDuration = mutable_state(void 0, true);
  ...
  let mounted = mutable_state(false, true);
  let removed = mutable_state(false, true);
  let swiping = mutable_state(false, true);
  let swipeOut = mutable_state(false, true);
  let offsetBeforeRemove = mutable_state(0, true);
  let initialHeight = mutable_state(0, true);
  let toastRef = mutable_state(void 0, true);
  let offset = mutable_state(0, true);
  ...
  let timeoutId = mutable_state(void 0, true);
  let remainingTime = mutable_state(toast2().duration || duration() || TOAST_LIFETIME, true);
  function pauseTimer() {
  ...
  let effect = mutable_state(void 0, true);
  onMount(() => {
    set(mounted, true);
  ...
  const class_derived = derived_safe_equal(() => {
  ...
  template_effect(() => set_attribute(li, "data-promise", Boolean(toast2().promise)));
  template_effect(() => set_attribute(li, "data-expanded", Boolean(expanded() || expandByDefault() && get(mounted))));
  var node = child(li);
  if_block(node, () => closeButton() && !toast2().component, ($$anchor2) => {
    var button = root_13();
    var event_handler = derived(() => get(disabled) ? void 0 : () => {
      var _a, _b;
      deleteToast();
      (_b = (_a = toast2()).onDismiss) == null ? void 0 : _b.call(_a, toast2());
    });
    const class_derived_1 = derived_safe_equal(() => {
      var _a, _b, _c;
    ...
    template_effect(() => {
      ...
      set_class(button, get(class_derived_1));
    });
    event("click", button, function(...$$args) {
      apply(() => get(event_handler), this, $$args, Toast, [279, 13]);
    });
  ...
  if_block(
    ...
    ($$anchor2) => {
      ...
      if_block(node_3, () => strict_equals(get(toastType), "default", false) || toast2().icon || toast2().promise, ($$anchor3) => {
        var div = root_4();
        var node_4 = child(div);
        if_block(node_4, () => (toast2().promise || strict_equals(get(toastType), "loading")) && !toast2().icon, ($$anchor4) => {
          var fragment_2 = comment();
        ...
        if_block(
          ...
          ($$anchor4) => {
            ...
            if_block(
              node_8,
              () => strict_equals(get(toastType), "success"),
              ($$anchor5) => {
              ...
              ($$anchor5) => {
                ...
                if_block(
                  node_10,
                  () => strict_equals(get(toastType), "error"),
                  ($$anchor6) => {
                  ...
                  ($$anchor6) => {
                    ...
                    if_block(
                      node_12,
                      () => strict_equals(get(toastType), "warning"),
                      ($$anchor7) => {
                      ...
                      ($$anchor7) => {
                        ...
                        if_block(
                          node_14,
                          () => strict_equals(get(toastType), "info"),
                          ($$anchor8) => {
      ...
      if_block(node_16, () => toast2().title, ($$anchor3) => {
        var div_2 = root_15();
        const class_derived_2 = derived_safe_equal(() => {
          var _a, _b, _c;
        ...
        if_block(
          node_17,
          () => strict_equals(typeof toast2().title, "string", false),
          ($$anchor4) => {
            var fragment_12 = comment();
            var node_18 = first_child(fragment_12);
            component(node_18, () => toast2().title, ($$anchor5, $$component) => {
      ...
      if_block(node_19, () => toast2().description, ($$anchor3) => {
        var div_3 = root_18();
        const class_derived_3 = derived_safe_equal(() => {
          var _a, _b;
        ...
        if_block(
          node_20,
          () => strict_equals(typeof toast2().description, "string", false),
          ($$anchor4) => {
            var fragment_14 = comment();
            var node_21 = first_child(fragment_14);
            component(node_21, () => toast2().description, ($$anchor5, $$component) => {
              $$component($$anchor5, spread_props(() => toast2().componentProps));
            });
      ...
      if_block(node_22, () => toast2().cancel, ($$anchor3) => {
        var button_1 = root_21();
        const class_derived_4 = derived_safe_equal(() => {
          var _a, _b, _c;
        ...
        reset(button_1);
        template_effect(() => {
          set_attribute(button_1, "style", cancelButtonStyle());
          set_class(button_1, get(class_derived_4));
      ...
      if_block(node_23, () => toast2().action, ($$anchor3) => {
        var button_2 = root_22();
        const class_derived_5 = derived_safe_equal(() => {
          var _a, _b, _c;
        ...
        reset(button_2);
        template_effect(() => {
          set_attribute(button_2, "style", actionButtonStyle());
          set_class(button_2, get(class_derived_5));
  ...
  template_effect(() => {
    ...
    set_attribute(li, "style", `${$$sanitized_props.style} ${toast2().style}`);
    set_style(li, "--index", index2());
    set_style(li, "--toasts-before", index2());
    set_style(li, "--z-index", $toasts().length - index2());
    set_style(li, "--offset", `${get(removed) ? get(offsetBeforeRemove) : get(offset)}px`);
    set_style(li, "--initial-height", `${get(initialHeight)}px`);
  });
...
function Toaster($$anchor, $$props) {
  ...
  const $toasts = () => (validate_store(toasts, "toasts"), store_get(toasts, "$toasts", $$stores));
  const $heights = () => (validate_store(heights, "heights"), store_get(heights, "$heights", $$stores));
  const possiblePositions = mutable_state();
  const hotkeyLabel = mutable_state();
  ...
  let interacting = mutable_state(false);
  let actualTheme = mutable_state(getInitialTheme(theme()));
  let listRef = mutable_state();
  ...
  var fragment = comment();
  var node = first_child(fragment);
  if_block(node, () => $toasts().length > 0, ($$anchor2) => {
    var section = root_14();
    set_attribute(section, "tabindex", -1);
    const $$array_1 = () => get(possiblePositions);
    each(section, 5, $$array_1, index, ($$anchor3, position2, index2) => {
      var ol = root_2();
      let attributes;
      const $$array = () => $toasts().filter((toast2) => !toast2.position && strict_equals(index2, 0) || strict_equals(toast2.position, get(position2)));
      ...
      each(ol, 7, $$array, (toast2) => toast2.id, ($$anchor4, toast2, index3) => {
        var fragment_1 = comment();
        var node_1 = first_child(fragment_1);
        var actionButtonStyle = derived_safe_equal(() => {
          var _a;
          return ((_a = toastOptions()) == null ? void 0 : _a.actionButtonStyle) || "";
        });
        var cancelButtonStyle = derived_safe_equal(() => {
          var _a;
          return ((_a = toastOptions()) == null ? void 0 : _a.cancelButtonStyle) || "";
        });
        var class_1 = derived_safe_equal(() => {
          var _a;
          return ((_a = toastOptions()) == null ? void 0 : _a.class) || "";
        });
        var descriptionClass = derived_safe_equal(() => {
          var _a;
          return ((_a = toastOptions()) == null ? void 0 : _a.descriptionClass) || "";
        });
        var classes = derived_safe_equal(() => toastOptions().classes || {});
        var duration_1 = derived_safe_equal(() => {
          var _a;
          return ((_a = toastOptions()) == null ? void 0 : _a.duration) ?? duration();
        });
        var unstyled = derived_safe_equal(() => toastOptions().unstyled || false);
        Toast_default(node_1, {
          ...
          get actionButtonStyle() {
            return get(actionButtonStyle);
          },
          get cancelButtonStyle() {
            return get(cancelButtonStyle);
          },
          get class() {
            return get(class_1);
          },
          get descriptionClass() {
            return get(descriptionClass);
          },
          get classes() {
            return get(classes);
          },
          get duration() {
            return get(duration_1);
          },
          get unstyled() {
            return get(unstyled);
          },
          $$slots: {
            "loading-icon": ($$anchor5, $$slotProps) => {
              ...
              slot(node_2, $$props, "loading-icon", {}, ($$anchor6) => {
                var fragment_3 = comment();
                var node_3 = first_child(fragment_3);
                var visible = derived_safe_equal(() => strict_equals(get(toast2).type, "loading"));
      ...
      template_effect(() => {
        ...
        attributes = set_attributes(
          ...
          attributes,
          {
            ...
            dir: strict_equals(dir(), "auto") ? getDocumentDirection() : dir(),
            "data-y-position": get(position2).split("-")[0],
            "data-x-position": get(position2).split("-")[1],
            style: $$sanitized_props.style,
            ...$$restProps
          },
          "s-KjATBeAaNTDC"
        );
        set_style(ol, "--front-toast-height", `${(_a = $heights()[0]) == null ? void 0 : _a.height}px`);
        set_style(ol, "--offset", strict_equals(typeof offset(), "number") ? `${offset()}px` : offset() || VIEWPORT_OFFSET);
